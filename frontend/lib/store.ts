...
const DEFAULT_USERS: User[] = [
  ...
  },
  {
    id: 'f3',
    name: 'Bello Farms',
    email: 'bello@farms.com',
    phone: '+234 809 111 2222',
    role: 'farmer',
    avatar: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?w=150&auto=format&fit=crop',
    storeName: 'Bello Agro Ventures',
    storeSlug: 'bello-agro-ventures',
    location: 'Kaduna State, Nigeria',
    bio: 'Premium grade northern farm crops, wholesale and retail. We supply premium grains, fresh onions, tomatoes, tubers and fresh fruits.',
    bannerUrl: 'https://images.unsplash.com/photo-1464226184884-fa280b87c3a9?w=1200&auto=format&fit=crop',
    logoUrl: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=150&auto=format&fit=crop',
    isVerified: true
  },
  {
    id: 'b1',
...
const DEFAULT_PRODUCTS: Product[] = [
  ...
  },
  {
    id: 'p10',
    farmerId: 'f3',
    farmerName: 'Bello Agro Ventures',
    farmerSlug: 'bello-agro-ventures',
    name: 'Premium Parboiled Rice',
    category: 'Grains',
    description: 'Premium Kaduna stone-free parboiled rice. Exceptional swelling and taste. Great for families and events.',
    price: 30800,
    quantity: 90,
    unit: '50kg Bag',
    location: 'Kaduna State, Nigeria',
  ...
  },
  {
    ...
    name: 'Fresh Vine Tomatoes',
    category: 'Vegetables',
    description: 'Vibrant, thick-skinned tomatoes, ideal for paste and home cooking. Harvested fresh from northern irrigated lands.',
    price: 8200,
    quantity: 60,
    unit: 'Large Basket',
    location: 'Kaduna State, Nigeria',
  ...
  },
  {
    ...
    name: 'Golden Yolk Farm Eggs',
    category: 'Livestock & Poultry',
    description: 'Fresh organic chicken eggs, high protein yolks, sanitized shells. Perfect for bakeries and home breakfast.',
    price: 4500,
    quantity: 120,
    unit: 'Crate (30 Eggs)',
    location: 'Oyo State, Nigeria',
  ...
  },
  {
    ...
    name: 'Golden Yolk Farm Eggs',
    category: 'Livestock & Poultry',
    description: 'Grade-A farm eggs from free-range layers. Balanced nutrition, double checked for cracks.',
    price: 4350,
    quantity: 70,
    unit: 'Crate (30 Eggs)',
    location: 'Kaduna State, Nigeria',
  ...
  },
  {
    ...
    name: 'Live Broiler Chicken',
    category: 'Livestock & Poultry',
    description: 'Healthy grain-fed broilers, average weight 2.6kg. Healthy, active birds ready for processing.',
    price: 7900,
    quantity: 50,
    unit: 'Bird',
    location: 'Oyo State, Nigeria',
  ...
  },
  {
    ...
    name: 'Live Broiler Chicken',
    category: 'Livestock & Poultry',
    description: 'Premium northern broilers, weight 2.8kg, fully organic grain fed. Excellent health and high meat yield.',
    price: 7300,
    quantity: 40,
    unit: 'Bird',
    location: 'Kaduna State, Nigeria',
  ...
  },
  {
    ...
    name: 'Sweet White Yam',
    category: 'Roots & Tubers',
    description: 'Very sweet Abuja-type yams, long shelf life, perfect for pounding or boiling. Handpicked carefully.',
    price: 1950,
    quantity: 150,
    unit: 'Tubers (Medium)',
    location: 'Kaduna State, Nigeria',
  ...
  },
  {
    ...
    name: 'Organic Hass Avocado',
    category: 'Fruits',
    description: 'Creamy Hass avocados. Plump and rich in healthy oils. Great for immediate consumption or local sale.',
    price: 2700,
    quantity: 40,
    unit: 'Pack of 6',
    location: 'Enugu State, Nigeria',
  ...
  },
  {
    ...
    name: 'Organic Hass Avocado',
    category: 'Fruits',
    description: 'Organically grown rich avocado pears. Hand picked and safely boxed for delivery.',
    price: 2400,
    quantity: 50,
    unit: 'Pack of 6',
    location: 'Kaduna State, Nigeria',
